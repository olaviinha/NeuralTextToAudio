...
Colab for [AudioLDM](https://github.com/haoheliu/AudioLDM). This is probably the beginning of _"Stable Diffusion of audio"_. Currently capable of producing 16 kHz audio only.
